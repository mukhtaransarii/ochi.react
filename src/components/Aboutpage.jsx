  ...
  return (
    <div className="">
     ...
     <div class="cardInnerbox p-8">
             <h2 className="text-[4vw] md:text-[2vw]">• Mukhtar Alam</h2>
             <div class="card bg-center bg-no-repeat bg-cover bg-[url('../../public/AboutImg.png')] w-full h-[30vh] md:w-[40vw] md:h-[30vw] bg-zinc-500 rounded-xl my-[4vw]  md:my-[2vw]"></div>
             <p className="text-[4vw] md:text-[2vw] mb-2">Frontend Web developer with 1 years of
               experience looking for internship to learn
               MERN Stack skills. Also I'm good at Typing
               and English Speaking I completed my
               English Course from FEA.</p>
             ...
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">WEBSITES</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">MORDEN</button>
             <button className="border-zinc-950 border-[1px] rounded-[100px] px-3 w-fit mr-3 mb-3">ANIMATED</button>
          </div>
    </div>
  )
}
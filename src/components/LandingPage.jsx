...
export default function LandingPage() {
  ...
  return (
    <div className="h-screen w-full">
     ...
     {["WE CREATE", "EYE OPENING", "PRESENTATION"]
       .map((item, index) => {
         return  <div class="masker">
                 ...
                 {index === 1 && (<div  className="w-[14vw] h-[9.5vw] bg-center bg-cover bg-[url('https://ochi.design/wp-content/uploads/2022/04/content-image01.jpg')]  md:w-[9vw] md:h-[6vw] bg-[#CDEA68] rounded mb-[7%]"></div>)}
     ...
     {["Follow me on Instagram", "Wanna see my repository?", "START THE PROJECT"]
